...
import { VictoryChart, VictoryArea ,VictoryLabel, VictoryTheme, VictoryStack } from 'victory';

export default class AreaAnimation2 extends React.Component {
  constructor() {
    super();
    this.state = {
      data: this.getData(),
  ...
  render() {
    const style = {
      parent: { border: "none", margin: "2%", maxWidth: "20%" }
    };
